...
public:
    ...
    void setupUi(QMainWindow *IHMPendu)
    {
        ...
        FichierMots->setGeometry(QRect(40, 510, 411, 17));
        ...
        MotaTrouverLabel->setGeometry(QRect(290, 200, 101, 21));
        MotCacher = new QLabel(centralwidget);
        MotCacher->setObjectName(QString::fromUtf8("MotCacher"));
        MotCacher->setEnabled(true);
        MotCacher->setGeometry(QRect(290, 230, 341, 61));
        QFont font1;
        font1.setPointSize(20);
        font1.setBold(true);
        font1.setWeight(75);
        MotCacher->setFont(font1);
        ...
        nombreErreur->setGeometry(QRect(40, 340, 191, 21));
        QFont font2;
        font2.setPointSize(10);
        font2.setBold(true);
        font2.setWeight(75);
        nombreErreur->setFont(font2);
